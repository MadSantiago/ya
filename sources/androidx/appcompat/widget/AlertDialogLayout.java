...
public class AlertDialogLayout extends AbstractC2338 {
    ...
    public static int m34(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m34(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt != null && childAt.getVisibility() != 8) {
                ...
                int i12 = ((LinearLayout.LayoutParams) c4044).gravity;
                if (i12 < 0) {
                    i12 = i10;
                }
                ...
                if (absoluteGravity != 1) {
                    if (absoluteGravity != 5) {
                        i7 = ((LinearLayout.LayoutParams) c4044).leftMargin + paddingLeft;
                    } else {
                        i5 = paddingRight - measuredWidth;
                        i6 = ((LinearLayout.LayoutParams) c4044).rightMargin;
                    }
                    if (m4379(i11)) {
                        paddingTop += intrinsicHeight;
                    }
                    int i13 = paddingTop + ((LinearLayout.LayoutParams) c4044).topMargin;
                    childAt.layout(i7, i13, measuredWidth + i7, i13 + measuredHeight2);
                    paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) c4044).bottomMargin + i13;
                } else {
                    i5 = ((paddingRight2 - measuredWidth) / 2) + paddingLeft + ((LinearLayout.LayoutParams) c4044).leftMargin;
                    i6 = ((LinearLayout.LayoutParams) c4044).rightMargin;
                }
                i7 = i5 - i6;
                if (m4379(i11)) {
                ...
                int i14 = paddingTop + ((LinearLayout.LayoutParams) c4044).topMargin;
                childAt.layout(i7, i14, measuredWidth + i7, i14 + measuredHeight2);
                paddingTop = measuredHeight2 + ((LinearLayout.LayoutParams) c4044).bottomMargin + i14;
            }
        }
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM34 = m34(view2);
            measuredHeight = view2.getMeasuredHeight() - iM34;
            paddingBottom += iM34;
        ...
        if (view2 != null) {
            int i5 = paddingBottom - iM34;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM34 += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM34, 1073741824));
        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c4044).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) c4044).height;
                        ((LinearLayout.LayoutParams) c4044).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) c4044).height = i9;
                    }
                }
                i8++;
