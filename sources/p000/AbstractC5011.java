...
/* JADX INFO: renamed from: ۦۘؓؒ٘, reason: contains not printable characters */
/* JADX INFO: compiled from: r8-map-id-0d494f8b6d83be2bf58e981e38c510150c6d0fab5a67cb4d4c794ec6fd37749a */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC5011 {
    static {
        int i = AbstractC5529.f18251;
    }

    /* JADX INFO: renamed from: ۥؗ */
    public static int m8425(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int length;
        int i5;
    ...
    public static int m8426(String str) {
                        ...
                        if (cCharAt2 < 2048) {
                            ...
                            if (cCharAt2 >= 55296 && cCharAt2 <= 57343) {
                                if (Character.codePointAt(str, i2) < 65536) {
                                    throw new C1080(C0958.m1990(length2, i2, (byte) 32, "Unpaired surrogate at index ", " of "));
                                }
                                i2++;
                            }
                        }
    ...
    public static boolean m8427(byte[] bArr, int i, int i2) {
        while (i < i2 && bArr[i] >= 0) {
            i++;
        }
        if (i >= i2) {
  ...
  0x0091: PHI (r4v6 byte) = (r4v5 byte), (r4v9 byte) binds: [B:41:0x008c, B:43:0x0090] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static String m8428(byte[] bArr, int i, int i2) throws C5463 {
        if (i2 == 0) {
            return "";
        }
        ...
        while (i < i3) {
            ...
            if (b2 >= 0) {
                ...
                if (b2 >= -32) {
                    if (b2 >= -16) {
                        if (i5 >= i3 - 2) {
                            C2316.m4358("Protocol message had invalid UTF-8.");
                            return null;
                        }
                        byte b4 = bArr[i5];
                        int i6 = i + 3;
                        ...
                        i += 4;
                        byte b6 = bArr[i6];
                        if (!AbstractC2164.m4190(b4)) {
                            if ((((b4 + 112) + (b2 << 28)) >> 30) == 0 && !AbstractC2164.m4190(b5) && !AbstractC2164.m4190(b6)) {
                    ...
                    i += 3;
                    byte b8 = bArr[i9];
                    if (!AbstractC2164.m4190(b7)) {
                        if (b2 != -32) {
                            if (b2 != -19) {
                                if (!AbstractC2164.m4190(b8)) {
                ...
                i += 2;
                byte b9 = bArr[i5];
                if (b2 < -62 || AbstractC2164.m4190(b9)) {
                    C2316.m4358("Protocol message had invalid UTF-8.");
                    return null;
                }
