...
/* JADX INFO: renamed from: ۥُٜٔ, reason: contains not printable characters */
...
public abstract class AbstractC1373 {
    ...
    public static int m2909(int i, int i2, int i3, int i4, int i5) {
        if (i5 == 0) {
            return 0;
        }
    ...
    public static int m2910(int i, int i2) {
        ...
        return Color.argb(i3, m2909(Color.red(i), iAlpha2, Color.red(i2), iAlpha, i3), m2909(Color.green(i), iAlpha2, Color.green(i2), iAlpha, i3), m2909(Color.blue(i), iAlpha2, Color.blue(i2), iAlpha, i3));
    }

    /* JADX INFO: renamed from: ۥۣ */
    public static int m2911(double d, double d2, double d3) {
    ...
    public static int m2912(int i, int i2) {
        if (i2 >= 0 && i2 <= 255) {
            return (i & 16777215) | (i2 << 24);
        }
        C1078.m2272("alpha must be between 0 and 255.");
        return 0;
    }
}
