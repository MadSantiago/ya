...
public final class InterpolatorC5824 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float[] fArr = this.f19168;
        int iMin = Math.min((int) ((fArr.length - 1) * f), fArr.length - 2);
        float f2 = this.f19167;
